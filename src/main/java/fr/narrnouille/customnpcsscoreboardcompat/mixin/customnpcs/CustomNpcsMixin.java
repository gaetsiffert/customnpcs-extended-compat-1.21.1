...
public abstract class CustomNpcsMixin {
    ...
    private static void customnpcsScoreboardCompat$syncScoreUpdateObjectiveSafely(ServerGamePacketListenerImpl connection, Packet<?> packet) {
    ...
    private static <T> Optional<T> customnpcsScoreboardCompat$allowNullScoreUpdateOptional(T value) {
